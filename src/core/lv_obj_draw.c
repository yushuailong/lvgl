...
static lv_color_t mix_layer_filter_color(const lv_draw_dsc_base_t * base_dsc, lv_color_t color);
static lv_color_t image_recolor_mix_filter_color(const lv_draw_dsc_base_t * base_dsc, lv_color_t recolor,
                                                 lv_opa_t recolor_opa, lv_opa_t * opa);
...
void lv_obj_init_draw_rect_dsc(lv_obj_t * obj, lv_part_t part, lv_draw_rect_dsc_t * draw_dsc)
{
    ...
    if(draw_dsc->bg_opa != LV_OPA_TRANSP) {
        ...
        if(draw_dsc->bg_opa > LV_OPA_MIN) {
            draw_dsc->bg_color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_bg_color(obj, part));
            ...
            if(grad && grad->dir != LV_GRAD_DIR_NONE) {
                ...
                if(draw_dsc->bg_grad.dir != LV_GRAD_DIR_NONE) {
                    draw_dsc->bg_grad.stops[0].color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_bg_color(obj, part));
                    draw_dsc->bg_grad.stops[1].color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_bg_grad_color(obj, part));
    ...
    if(draw_dsc->border_opa != LV_OPA_TRANSP) {
        ...
        if(draw_dsc->border_width) {
            ...
            if(draw_dsc->border_opa > LV_OPA_MIN) {
                ...
                draw_dsc->border_color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_border_color(obj, part));
            }
        }
    }
    ...
    if(draw_dsc->outline_opa != LV_OPA_TRANSP) {
        ...
        if(draw_dsc->outline_width) {
            ...
            if(draw_dsc->outline_opa > LV_OPA_MIN) {
                ...
                draw_dsc->outline_color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_outline_color(obj, part));
            }
        }
    }
        ...
        if(draw_dsc->bg_image_src) {
            ...
            if(draw_dsc->bg_image_opa > LV_OPA_MIN) {
                if(lv_image_src_get_type(draw_dsc->bg_image_src) == LV_IMAGE_SRC_SYMBOL) {
                    ...
                    draw_dsc->bg_image_recolor = image_recolor_mix_filter_color(&draw_dsc->base, draw_dsc->bg_image_recolor,
                                                                                draw_dsc->bg_image_recolor_opa, &draw_dsc->bg_image_recolor_opa);
        ...
        if(draw_dsc->shadow_width) {
            if(draw_dsc->shadow_opa > LV_OPA_MIN) {
                ...
                if(draw_dsc->shadow_opa > LV_OPA_MIN) {
                    ...
                    draw_dsc->shadow_color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_shadow_color(obj, part));
                }
            }
        }
    }
...
void lv_obj_init_draw_label_dsc(lv_obj_t * obj, lv_part_t part, lv_draw_label_dsc_t * draw_dsc)
{
    ...
    draw_dsc->color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_text_color(obj, part));
...
void lv_obj_init_draw_image_dsc(lv_obj_t * obj, lv_part_t part, lv_draw_image_dsc_t * draw_dsc)
{
    ...
    draw_dsc->recolor = image_recolor_mix_filter_color(&draw_dsc->base, draw_dsc->recolor, draw_dsc->recolor_opa,
...
void lv_obj_init_draw_line_dsc(lv_obj_t * obj, lv_part_t part, lv_draw_line_dsc_t * draw_dsc)
{
    ...
    draw_dsc->color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_line_color(obj, part));
...
void lv_obj_init_draw_arc_dsc(lv_obj_t * obj, lv_part_t part, lv_draw_arc_dsc_t * draw_dsc)
{
    ...
    draw_dsc->color = mix_layer_filter_color(&draw_dsc->base, lv_obj_get_style_arc_color(obj, part));
...
static lv_color_t mix_layer_filter_color(const lv_draw_dsc_base_t * base_dsc, lv_color_t color)
{
    if(!base_dsc->layer || base_dsc->layer->color_filter_opa <= LV_OPA_TRANSP) {
        return color;
    }

    return lv_color_mix(base_dsc->layer->color_filter, color, base_dsc->layer->color_filter_opa);
}
                                                 ...
                                                 lv_opa_t recolor_opa, lv_opa_t * opa)
{
    ...
    if(recolor_opa <= LV_OPA_TRANSP) {
        *opa = base_dsc->layer->color_filter_opa;
        return base_dsc->layer->color_filter;
    }

    *opa = base_dsc->layer->color_filter_opa;
    return lv_color_mix(recolor, base_dsc->layer->color_filter, recolor_opa);
}